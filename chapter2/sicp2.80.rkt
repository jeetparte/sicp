...
(display "test ordinary numbers")
(newline)
(=zero? 1)
(=zero? 0)
(display "test rational numbers")
(newline)
(define r1 (make-rational 0 1))
(define r2 (make-rational 5 0))
(=zero? r1)
(=zero? r2)
(display "test complex numbers")
(newline)
(define z1 (make-complex-from-real-imag 0 0))
(define z2 (make-complex-from-mag-ang 0 4))
(define z3 (make-complex-from-mag-ang 3 0))
(=zero? z1)
(=zero? z2)
(=zero? z3)